...
| [Componentes](Components.md) | Catálogo de componentes Astro y su uso |
| [Páginas](Pages.md) | Mapa completo de rutas y su contenido |
| [Despliegue](Deployment.md) | GitHub Pages (actual) y Cloudflare Pages (futuro) |
...
- **Framework:** Astro 7 (modo estático)
...
- **Repositorio:** [github.com/senseikatana/empresaplana-webiste](https://github.com/senseikatana/empresaplana-webiste)
